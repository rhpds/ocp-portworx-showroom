= Install Portworx and configure storage
...
Make sure you are in the terminal tab to your right.
...
.install-operator
image:02-pxeinstall-installoperator-01.png[install-operator,link=self,window=blank]
...
.install-operator02
image:03-pxeinstall-installoperator-02.png[install-operator02,link=self,window=blank]
...
.install-operator03
image:04-pxeinstall-installoperator-03.png[install-operator03,link=self,window=blank]
...
https://docs.portworx.com/portworx-enterprise/platform/openshift/ocp-gcp/install-on-ocp-gcp[Portworx documentation for OpenShift^]
